...
<div class="herramientas">
  <div class="grupo">
    <a class="grupo-btn" href="/items" aria-label="Volver a Inventario" title="Volver a Inventario">
...
<div class="card">
  ...
  <div class="filtros">
    ...
    <div class="campos">
      ...
      <button type="button" class="btn btn-primary btn-sm buscar" on:click={cargarMovimientos}>
